...
import * as S from './UserDashboard.styled';
  ...
  return (
    <S.Container>
      <S.MainContent>
        ...
        {/* 내 프로젝트 진행률 */}
        <S.Section>
          <S.SectionTitle>내 프로젝트 진행률</S.SectionTitle>
          <S.ProgressList>
            <S.ProgressItem>
        ...
        <S.FlexRow>
          ...
          <S.MentionedSection>
            ...
            <S.MentionedCard color="yellow">
              ...
              <S.MentionedDesc>@김개발님, 메인 페이지 레이아웃에 대한 의견 부탁드립니다.</S.MentionedDesc>
              <S.MentionedMeta>2시간 전</S.MentionedMeta>
            </S.MentionedCard>
            <S.MentionedCard color="blue">
              <S.MentionedTitle>코드 리뷰 완료</S.MentionedTitle>
              <S.MentionedDesc>@김개발님이 작성한 컴포넌트 리뷰가 완료되었습니다.</S.MentionedDesc>
              <S.MentionedMeta>5시간 전</S.MentionedMeta>
            </S.MentionedCard>
          </S.MentionedSection>

          {/* 우선순위 높은 게시글 */}
          <S.PrioritySection>
            <S.PriorityTitle>우선순위 높은 게시글</S.PriorityTitle>
            <S.PriorityCard>
              <S.PriorityHeader>
                <S.PriorityLabel>긴급 버그 수정 요청</S.PriorityLabel>
                <S.PriorityTag>긴급</S.PriorityTag>
              </S.PriorityHeader>
              <S.PriorityDesc>최신 모듈에서 오류가 발생하고 있습니다. 즉시 확인 부탁드립니다.</S.PriorityDesc>
              <S.PriorityMeta>
                <span>30분 전</span>
                <span>5</span>
              </S.PriorityMeta>
            ...
            <S.PriorityCard>
              <S.PriorityHeader>
                <S.PriorityLabel>클라이언트 승인 대기</S.PriorityLabel>
                <S.PriorityTag type="yellow">보류</S.PriorityTag>
              </S.PriorityHeader>
              <S.PriorityDesc>최종 디자인안에 대한 클라이언트 피드백이 필요합니다.</S.PriorityDesc>
              <S.PriorityMeta>
                <span>1시간 전</span>
                <span>3</span>
              </S.PriorityMeta>
