...
export const LeftPanel: React.FC<Props> = ({ showLockInfo = false }) => (
  <ComponentLeft>
    ...
    <DescIconContainer>
      <DescIconImage src={checkIcon} alt="Check Icon" />
      <DescIconText>효율적인 프로젝트 관리 시스템</DescIconText>
    </DescIconContainer>
    <DescIconContainer>
      <DescIconImage src={teamIcon} alt="Team Icon" />
      <DescIconText>팀 협업 및 커뮤니케이션 향상</DescIconText>
    </DescIconContainer>
    <DescIconContainer>
      <DescIconImage src={chartIcon} alt="Chart Icon" />
    ...
    {showLockInfo && (
      <>
        <LockContainer>
          <LockIconImage src={lockIcon} alt="Lock Icon" />
