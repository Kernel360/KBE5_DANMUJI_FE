    ...
    <div>
            ...
            {filtered.map((p: Project, idx: number) => (
              <tr key={p.id} className="border-b last:border-b-0">
                ...
                <td className="px-4 py-2 flex gap-2">
                  ...
                  <button className="bg-red-100 text-red-500 px-2 py-1 rounded text-xs hover:bg-red-200">
                    삭제
                  </button>
                </td>
              </tr>
      ...
      <div className="flex justify-center mt-6">
        <nav className="inline-flex -space-x-px">
          <button
            className="px-3 py-1 border rounded-l bg-white text-gray-500 hover:bg-gray-100"
            disabled
          >
            {"<"}
          </button>
          <button className="px-3 py-1 border-t border-b bg-blue-50 text-blue-600 font-bold">
            1
          </button>
          <button
            className="px-3 py-1 border rounded-r bg-white text-gray-500 hover:bg-gray-100"
            disabled
          >
            {">"}
          </button>
